...
class ChartingState extends MusicBeatState
{
	...
	**/
	...
	function addSongUI():Void
	{
		...
		var check_mute_voice = new FlxUICheckBox(10, 260, null, null, "Mute Voices (in editor)", 100);
		...
		player2TextField = new FlxUIInputText(140, 100, 70, _song.player2, 8);
	...
	function addNoteUI():Void
	{
		...
		check_altNote = new FlxUICheckBox(10, 80, null, null, "Alt Note", 100);
